...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('form-1').addEventListener('submit', function (e) {
    ...
    var identityRequest = {
      userIdentities: {//customerid: `${e.target[0].value}-Test${e.target[1].value[2]}`,
    ...
    if (e.target[0].flag) {
      identityRequest.userIdentities.mobile_number = e.target[0].value;
    }

    if (e.target[1].flag) {
      identityRequest.userIdentities.customerid = e.target[1].value;
    }

    if (e.target[2].flag) {
      identityRequest.userIdentities.email = e.target[2].value;
    }
  ...
  document.getElementById('purchase-event').addEventListener('click', function (e) {
    ...
    if (!(cart.length === 0)) {
      ...
      customAttributes[s_srv + "_Start_Date"] = start_date;
      customAttributes[s_srv + "_Length"] = document.getElementById("service_len").options[document.getElementById("service_len").selectedIndex].value;
      customAttributes[s_srv + "_End_Date"] = parseInt(start_date.split("-")[0]) + parseInt(document.getElementById("service_len").options[document.getElementById("service_len").selectedIndex].value) / 12 + start_date.substring(4); // ADD CUSTOM FLAGS
...
function updateUserIdentities(user) {
  ...
  if (Object.keys(user_profile).length === 0) {
    ...
    table2.children[0].children[3].children[0].innerText = "€" + "".concat(user_profile.user_attributes["cltv"] ? parseFloat(user_profile.user_attributes["cltv"], 10).toFixed(2) : "0");
    table2.children[0].children[3].children[1].innerText = "€" + "".concat(user_profile.user_attributes["average Order Value"] ? parseFloat(user_profile.user_attributes["average Order Value"], 10).toFixed(2) : "0");
    ...
    table2.children[0].children[5].children[2].innerText = "€" + "".concat(user_profile.user_attributes["last Order Value"] ? parseFloat(user_profile.user_attributes["last Order Value"], 10).toFixed(2) : "0");
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","vb-index.js"], null)
//# sourceMappingURL=/vb-index.js.map