...
var Base64$2 = {
  ...
  _encode: function (a) {
    ...
    for (a = UTF8.encode(a); k < a.length;) b = a.charCodeAt(k++), c = a.charCodeAt(k++), d = a.charCodeAt(k++), e = b >> 2, f = (3 & b) << 4 | c >> 4, g = (15 & c) << 2 | d >> 6, h = 63 & d, isNaN(c) ? g = h = 64 : isNaN(d) && (h = 64), j = j + Base64$2._keyStr.charAt(e) + Base64$2._keyStr.charAt(f) + Base64$2._keyStr.charAt(g) + Base64$2._keyStr.charAt(h);
  ...
  _decode: function (a) {
    ...
    for (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); k < a.length;) e = Base64$2._keyStr.indexOf(a.charAt(k++)), f = Base64$2._keyStr.indexOf(a.charAt(k++)), g = Base64$2._keyStr.indexOf(a.charAt(k++)), h = Base64$2._keyStr.indexOf(a.charAt(k++)), b = e << 2 | f >> 4, c = (15 & f) << 4 | g >> 2, d = (3 & g) << 6 | h, j += String.fromCharCode(b), 64 !== g && (j += String.fromCharCode(c)), 64 !== h && (j += String.fromCharCode(d));
...
var _TriggerUploadType,
  ...
  UserIdentityChange: 18
    ...
    TriggerUploadType = (_TriggerUploadType = {}, _defineProperty(_TriggerUploadType, MessageType$1.Commerce, 1), _defineProperty(_TriggerUploadType, MessageType$1.UserAttributeChange, 1), _defineProperty(_TriggerUploadType, MessageType$1.UserIdentityChange, 1), _TriggerUploadType),
    EventType = {
  Unknown: 0,
  Navigation: 1,
  Location: 2,
...
IdentityType.isValid = function (a) {
  if ("number" == typeof a) for (var b in IdentityType) if (IdentityType.hasOwnProperty(b) && IdentityType[b] === a) return !0;
  return !1;
}, IdentityType.getName = function (a) {
...
}, IdentityType.getIdentityType = function (a) {
  return "other" === a ? IdentityType.Other : "customerid" === a ? IdentityType.CustomerId : "facebook" === a ? IdentityType.Facebook : "twitter" === a ? IdentityType.Twitter : "google" === a ? IdentityType.Google : "microsoft" === a ? IdentityType.Microsoft : "yahoo" === a ? IdentityType.Yahoo : "email" === a ? IdentityType.Email : "facebookcustomaudienceid" === a ? IdentityType.FacebookCustomAudienceId : "other2" === a ? IdentityType.Other2 : "other3" === a ? IdentityType.Other3 : "other4" === a ? IdentityType.Other4 : "other5" === a ? IdentityType.Other5 : "other6" === a ? IdentityType.Other6 : "other7" === a ? IdentityType.Other7 : "other8" === a ? IdentityType.Other8 : "other9" === a ? IdentityType.Other9 : "other10" === a ? IdentityType.Other10 : "mobile_number" === a ? IdentityType.MobileNumber : "phone_number_2" === a ? IdentityType.PhoneNumber2 : !("phone_number_3" != a) && IdentityType.PhoneNumber3;
}, IdentityType.getIdentityName = function (a) {
  return a === IdentityType.Other ? "other" : a === IdentityType.CustomerId ? "customerid" : a === IdentityType.Facebook ? "facebook" : a === IdentityType.Twitter ? "twitter" : a === IdentityType.Google ? "google" : a === IdentityType.Microsoft ? "microsoft" : a === IdentityType.Yahoo ? "yahoo" : a === IdentityType.Email ? "email" : a === IdentityType.FacebookCustomAudienceId ? "facebookcustomaudienceid" : a === IdentityType.Other2 ? "other2" : a === IdentityType.Other3 ? "other3" : a === IdentityType.Other4 ? "other4" : a === IdentityType.Other5 ? "other5" : a === IdentityType.Other6 ? "other6" : a === IdentityType.Other7 ? "other7" : a === IdentityType.Other8 ? "other8" : a === IdentityType.Other9 ? "other9" : a === IdentityType.Other10 ? "other10" : a === IdentityType.MobileNumber ? "mobile_number" : a === IdentityType.PhoneNumber2 ? "phone_number_2" : a === IdentityType.PhoneNumber3 ? "phone_number_3" : void 0;
};
...
function convertEvents(a, b, c) {
  ...
  for (var d, e = [], f = null, g = 0, h = b; g < h.length; g++) if (d = h[g], d) {
    f = d;
    var i = convertEvent(d);
    i && e.push(i);
  }
  ...
  var j = {
    ...
    environment: f.Debug ? dist.BatchEnvironmentEnum.development : dist.BatchEnvironmentEnum.production,
    events: e,
    mp_deviceid: f.DeviceId,
    sdk_version: f.SDKVersion,
    application_info: {
      application_version: f.AppVersion,
      application_name: f.AppName,
      package: f.Package
    },
    device_info: {
    ...
    user_attributes: f.UserAttributes,
    user_identities: convertUserIdentities(f.UserIdentities),
    consent_state: convertConsentState(f.ConsentState),
    integration_attributes: f.IntegrationAttributes
  };
  return f.DataPlan && f.DataPlan.PlanId && (j.context = {
    data_plan: {
      plan_id: f.DataPlan.PlanId,
      plan_version: f.DataPlan.PlanVersion || void 0
    }
  }), j;
}
...
function () {
  function a(b, c) {
    var d = this;
    this.mpInstance = b, this.uploadIntervalMillis = c, this.batchingEnabled = c >= a.MINIMUM_INTERVAL_MILLIS, this.uploadIntervalMillis < a.MINIMUM_INTERVAL_MILLIS && (this.uploadIntervalMillis = a.MINIMUM_INTERVAL_MILLIS), this.pendingEvents = [], this.pendingUploads = [];

    var e = this.mpInstance._Store,
        f = e.SDKConfig,
        g = e.devToken,
        h = this.mpInstance._Helpers.createServiceUrl(f.v3SecureServiceUrl, g);

    this.uploadUrl = "".concat(h, "/events"), setTimeout(function () {
      d.prepareAndUpload(!0, !1);
    }, this.uploadIntervalMillis), this.addEventListeners();
  }

  return a.prototype.addEventListeners = function () {
    var a = this;
    ...
    a && (this.pendingEvents.push(a), this.mpInstance.Logger.verbose("Queuing event: ".concat(JSON.stringify(a))), this.mpInstance.Logger.verbose("Queued event count: ".concat(this.pendingEvents.length)), (!this.batchingEnabled || Types.TriggerUploadType[a.EventDataType]) && this.prepareAndUpload(!1, !1));
  }, a.createNewUploads = function (a, b, c) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (l) {
        switch (l.label) {
          case 0:
            return d = this.mpInstance.Identity.getCurrentUser(), e = this.pendingEvents, this.pendingEvents = [], f = a.createNewUploads(e, d, this.mpInstance), f && f.length && (i = this.pendingUploads).push.apply(i, f), g = this.pendingUploads, this.pendingUploads = [], [4
            /*yield*/
            , this.upload(this.mpInstance.Logger, g, c)];

          case 1:
            return h = l.sent(), h && h.length && (j = this.pendingUploads).unshift.apply(j, h), b && setTimeout(function () {
              k.prepareAndUpload(!0, !1);
            }, this.uploadIntervalMillis), [2
            /*return*/
            ];
        }
      });
    });
  }, a.prototype.upload = function (b, c, d) {
    return __awaiter(this, void 0, void 0, function () {
      var e, f, g, h, j, k;
      return __generator(this, function (i) {
        switch (i.label) {
          case 0:
            if (!c || 1 > c.length) return [2
            /*return*/
            , null];
            b.verbose("Uploading batches: ".concat(JSON.stringify(c))), b.verbose("Batch count: ".concat(c.length)), f = 0, i.label = 1;
          ...
          case 2:
            e || (window.fetch ? e = new FetchUploader(this.uploadUrl, b) : e = new XHRUploader(this.uploadUrl, b)), i.label = 3;

          case 3:
            return i.trys.push([3, 5,, 6]), [4
            /*yield*/
            , e.upload(g, c, f)];

          case 4:
            if (j = i.sent(), 200 <= j.status && 300 > j.status) b.verbose("Upload success for request ID: ".concat(c[f].source_request_id));else {
              if (500 <= j.status || 429 === j.status) //server error, add back current events and try again later
...
function (a) {
      ...
      return __generator(this, function (c) {
        switch (c.label) {
          case 0:
            return [4
            /*yield*/
            , this.makeRequest(this.url, this.logger, a.body)];
  ...
  }, b.prototype.makeRequest = function (a, b, c) {
    return __awaiter(this, void 0, void 0, function () {
      var b;
      return __generator(this, function () {
        return b = new XMLHttpRequest(), [2
        /*return*/
        , new Promise(function (d, e) {
          b.onreadystatechange = function () {
            4 !== b.readyState || (200 <= b.status && 300 > b.status ? d(b) : e(b));
          }, b.open("post", a), b.send(c);
        })];
      });
    });
  }, b;
...
function APIClient(a, b) {
  ...
  this.queueEventForBatchUpload = function (b) {
    ...
    var b = parseInt(a._Helpers.getFeatureFlag(Constants.FeatureFlags.EventsV3), 10);
    if (!b) return !1;

    var c = a._Helpers.getRampNumber(a._Store.deviceId);
    ...
    return g && (f = g.getMPID()), a._Store.requireDelay = a._Helpers.isDelayedByIntegration(a._preInit.integrationDelays, a._Store.integrationDelayTimeoutStart, Date.now()), f && !a._Store.requireDelay && a._Store.configurationLoaded ? void (this.processQueuedEvents(), c && e.shouldUploadEvent && (this.shouldEnableBatching() ? this.queueEventForBatchUpload(c) : this.sendSingleEventToServer(c)), c && c.EventName !== Types.MessageType.AppStateTransition && (b && b.kitBlockingEnabled && (c = b.createBlockedEvent(c)), c && a._Forwarders.sendEventToForwarders(c))) : (a.Logger.verbose("Event was added to eventQueue. eventQueue will be processed once a valid MPID is returned or there is no more integration imposed delay."), void a._Store.eventQueue.push(c));
  }, this.sendSingleEventToServer = function (b) {
    if (b.EventDataType !== Types.MessageType.Media) {
      var c,
          d = function xhrCallback() {
        4 === c.readyState && (a.Logger.verbose("Received " + c.statusText + " from server"), a._Persistence.update());
      };

      if (!b) return void a.Logger.error(Messages$9.ErrorMessages.EventEmpty);
      if (a.Logger.verbose(Messages$9.InformationMessages.SendHttp), c = a._Helpers.createXHR(d), c) try {
        c.open("post", a._Helpers.createServiceUrl(a._Store.SDKConfig.v2SecureServiceUrl, a._Store.devToken) + "/Events"), c.send(JSON.stringify(a._ServerModel.convertEventToDTO(b)));
      } catch (b) {
        a.Logger.error("Error sending event to mParticle servers. " + b);
      }
    }
...
var Validators = {
  ...
  isStringOrNumber: function isStringOrNumber(a) {
...
function Helpers(a) {
  function b(b) {
    var a;
    return window.crypto && window.crypto.getRandomValues && (a = window.crypto.getRandomValues(new Uint8Array(1))), a ? (b ^ a[0] % 16 >> b / 4).toString(16) : (b ^ 16 * Math.random() >> b / 4).toString(16);
  }
  ...
  */
  ...
  this.canLog = function () {
  ...
  }, this.getRampNumber = function (a) {
    if (!a) return 100;
    var b = c.generateHash(a);
    return Math.abs(b % 100) + 1;
  }, this.invokeCallback = function (b, d, e, f, g) {
    b || a.Logger.warning("There is no callback provided");

    try {
      c.Validators.isFunction(b) && b({
        httpCode: d,
        body: e,
  ...
  }, this.invokeAliasCallback = function (b, d, e) {
    b || a.Logger.warning("There is no callback provided");

    try {
      if (c.Validators.isFunction(b)) {
        var f = {
          httpCode: d
        };
        e && (f.message = e), b(f);
    ...
    return c;
  }, this.generateUniqueId = function (d) {
  ...
  }, this.filterUserIdentities = function (a, b) {
    var d = [];
    ...
    return d;
  }, this.filterUserIdentitiesForForwarders = function (a, b) {
    var d = {};
    if (a && Object.keys(a).length) for (var e in a) if (a.hasOwnProperty(e)) {
      var f = Types.IdentityType.getIdentityType(e);
      c.inArray(b, f) || (d[e] = a[e]);
    }
    return d;
  }, this.filterUserAttributes = function (a, b) {
    var d = {};
    if (a && Object.keys(a).length) for (var e in a) if (a.hasOwnProperty(e)) {
      var f = c.generateHash(e);
      c.inArray(b, f) || (d[e] = a[e]);
    }
    return d;
    ...
    return !1;
  }, this.parseStringOrNumber = function (a) {
    return Validators.isStringOrNumber(a) ? a : null;
    ...
    for (d = 0; d < a.length; d++) b = a.charCodeAt(d), c = (c << 5) - c + b, c &= c;

    return c;
  }, this.sanitizeAttributes = function (b, d) {
    if (!b || !c.isObject(b)) return null;
    var e = {};

    for (var f in b) // Make sure that attribute values are not objects or arrays, which are not valid
    b.hasOwnProperty(f) && c.Validators.isValidAttributeValue(b[f]) ? e[f] = b[f] : a.Logger.warning("For '" + d + "', the corresponding attribute value of '" + f + "' must be a string, number, boolean, or null.");
    ...
    return a ? StorageNames$2.currentStorageName + "_" + a : StorageNames$2.currentStorageName;
  }, this.createProductStorageName = function (a) {
    return a ? StorageNames$2.currentStorageProductsName + "_" + a : StorageNames$2.currentStorageProductsName;
  }, this.isSlug = function (a) {
    return a === Slugify(a);
  }, this.converted = converted, this.findKeyInObject = findKeyInObject, this.parseNumber = parseNumber, this.inArray = inArray, this.isObject = isObject, this.decoded = decoded, this.returnConvertedBoolean = returnConvertedBoolean, this.Validators = Validators;
}
...
function cookieSyncManager(a) {
  ...
  this.attemptCookieSync = function (c, d, e) {
    ...
    d && !a._Store.webviewBridgeEnabled && a._Store.pixelConfigurations.forEach(function (l) {
      ...
      }, h = b.replaceMPID(f.pixelUrl, d), i = f.redirectUrl ? b.replaceMPID(f.redirectUrl, d) : "", j = h + encodeURIComponent(i);

      var m = a._Persistence.getPersistence();
    ...
    if (!(h && g) && a._Consent.isEnabledForUserConsent(f, a.Identity.getCurrentUser())) {
...
function createSDKConfig(a) {
  ...
  if (a) for (c in a) a.hasOwnProperty(c) && (b[c] = a[c]);

  for (c in Constants.DefaultUrls) b[c] = Constants.DefaultUrls[c];
...
function Store(a, b) {
  ...
  if (this.integrationDelayTimeoutStart = Date.now(), this.SDKConfig = createSDKConfig(a), a) {
    ...
    if (a.hasOwnProperty("appVersion") && (this.SDKConfig.appVersion = a.appVersion), a.hasOwnProperty("appName") && (this.SDKConfig.appName = a.appName), a.hasOwnProperty("sessionTimeout") && (this.SDKConfig.sessionTimeout = a.sessionTimeout), a.hasOwnProperty("dataPlan") && (this.SDKConfig.dataPlan = {
      PlanVersion: null,
      PlanId: null
    }, a.dataPlan.hasOwnProperty("planId") && ("string" == typeof a.dataPlan.planId ? b._Helpers.isSlug(a.dataPlan.planId) ? this.SDKConfig.dataPlan.PlanId = a.dataPlan.planId : b.Logger.error("Your data plan id must be in a slug format") : b.Logger.error("Your data plan id must be a string")), a.dataPlan.hasOwnProperty("planVersion") && ("number" == typeof a.dataPlan.planVersion ? this.SDKConfig.dataPlan.PlanVersion = a.dataPlan.planVersion : b.Logger.error("Your data plan version must be a number"))), this.SDKConfig.forceHttps = !a.hasOwnProperty("forceHttps") || a.forceHttps, a.hasOwnProperty("customFlags") && (this.SDKConfig.customFlags = a.customFlags), this.SDKConfig.minWebviewBridgeVersion = a.hasOwnProperty("minWebviewBridgeVersion") ? a.minWebviewBridgeVersion : 1, this.SDKConfig.aliasMaxWindow = a.hasOwnProperty("aliasMaxWindow") ? a.aliasMaxWindow : Constants.DefaultConfig.aliasMaxWindow, a.hasOwnProperty("dataPlanOptions")) {
      var f = a.dataPlanOptions;
      f.hasOwnProperty("dataPlanVersion") && f.hasOwnProperty("blockUserAttributes") && f.hasOwnProperty("blockEventAttributes") && f.hasOwnProperty("blockEvents") && f.hasOwnProperty("blockUserIdentities") || b.Logger.error("Ensure your config.dataPlanOptions object has the following keys: a \"dataPlanVersion\" object, and \"blockUserAttributes\", \"blockEventAttributes\", \"blockEvents\", \"blockUserIdentities\" booleans");
    }
...
function _Persistence(a) {
  ...
  */
  ...
  this.useLocalStorage = function () {
    ...
    try {
      ...
      try {
        if (a._Store.isLocalStorageAvailable) {
          ...
          if (g) var h = JSON.parse(Base64$1.decode(g));
    ...
    if (f && (c = Base64$1.decode(f)), b) try {
    ...
    d && (b = Base64$1.decode(d)); // returns an object with keys of MPID and values of array of products
    ...
    if (a._Store.isLocalStorageAvailable) {
      ...
      if (h) {
        ...
        try {
          window.localStorage.setItem(encodeURIComponent(a._Store.prodStorageName), Base64$1.encode(JSON.stringify(d)));
        } catch (b) {
    ...
    for (var c in b = JSON.parse(b), b.gs) b.gs.hasOwnProperty(c) && (Base64CookieKeys[c] ? b.gs[c] ? Array.isArray(b.gs[c]) && b.gs[c].length || a._Helpers.isObject(b.gs[c]) && Object.keys(b.gs[c]).length ? b.gs[c] = Base64$1.encode(JSON.stringify(b.gs[c])) : delete b.gs[c] : delete b.gs[c] : "ie" === c ? b.gs[c] = b.gs[c] ? 1 : 0 : !b.gs[c] && delete b.gs[c]);

    for (var d in b) if (b.hasOwnProperty(d) && !SDKv2NonMPIDCookieKeys[d]) for (c in b[d]) b[d].hasOwnProperty(c) && Base64CookieKeys[c] && (a._Helpers.isObject(b[d][c]) && Object.keys(b[d][c]).length ? b[d][c] = Base64$1.encode(JSON.stringify(b[d][c])) : delete b[d][c]);

    return f.createCookieString(JSON.stringify(b));
  }, this.decodePersistence = function (b) {
    try {
      if (b) {
        if (b = JSON.parse(f.revertCookieString(b)), a._Helpers.isObject(b) && Object.keys(b).length) {
          for (var c in b.gs) b.gs.hasOwnProperty(c) && (Base64CookieKeys[c] ? b.gs[c] = JSON.parse(Base64$1.decode(b.gs[c])) : "ie" === c && (b.gs[c] = !!b.gs[c]));

          for (var d in b) if (b.hasOwnProperty(d)) if (!SDKv2NonMPIDCookieKeys[d]) for (c in b[d]) b[d].hasOwnProperty(c) && Base64CookieKeys[c] && b[d][c].length && (b[d][c] = JSON.parse(Base64$1.decode(b[d][c])));else "l" === d && (b[d] = !!b[d]);
        }
  ...
  }, this.replaceCommasWithPipes = function (a) {
    return a.replace(/,/g, "|");
  }, this.replacePipesWithCommas = function (a) {
    return a.replace(/\|/g, ",");
  }, this.replaceApostrophesWithQuotes = function (a) {
    return a.replace(/\'/g, "\"");
  }, this.replaceQuotesWithApostrophes = function (a) {
    return a.replace(/\"/g, "'");
  }, this.createCookieString = function (a) {
    return f.replaceCommasWithPipes(f.replaceQuotesWithApostrophes(a));
  }, this.revertCookieString = function (a) {
    return f.replacePipesWithCommas(f.replaceApostrophesWithQuotes(a));
    ...
    var c,
        d = localStorage.getItem(a._Store.prodStorageName);
    return d && (c = JSON.parse(Base64$1.decode(d)), c && c[b] && c[b].cp) ? c[b].cp : [];
  }, this.setCartProducts = function (b) {
    if (a._Store.isLocalStorageAvailable) try {
      window.localStorage.setItem(encodeURIComponent(a._Store.prodStorageName), Base64$1.encode(JSON.stringify(b)));
    } catch (b) {
      a.Logger.error("Error with setting products on localStorage.");
    }
    ...
    if (c(StorageNames$1.localStorageName), c(StorageNames$1.localStorageNameV3), c(StorageNames$1.localStorageNameV4), c(a._Store.prodStorageName), c(a._Store.storageName), c(StorageNames$1.localStorageProductsV4), f.expireCookies(StorageNames$1.cookieName), f.expireCookies(StorageNames$1.cookieNameV2), f.expireCookies(StorageNames$1.cookieNameV3), f.expireCookies(StorageNames$1.cookieNameV4), f.expireCookies(a._Store.prodStorageName), f.expireCookies(a._Store.storageName), mParticle._isTestEnv) {
...
function Migrations(a) {
  function b() {
    var b,
        ...
        j,
        k,
        m = window.document.cookie.split("; ");

    for (a.Logger.verbose(Constants.Messages.InformationMessages.CookieSearch), d = 0, f = m.length; d < f; d++) {
      try {
        g = m[d].split("="), j = a._Helpers.decoded(g.shift()), k = a._Helpers.decoded(g.join("="));
      } catch (b) {
        a.Logger.verbose("Unable to parse cookie: " + j + ". Skipping.");
      } //most recent version needs no migration


      if (j === a._Store.storageName) return;
      if (j === StorageNames.cookieNameV4) return c(k, StorageNames.cookieNameV4), void (a._Store.isLocalStorageAvailable && e()); // migration path for SDKv1CookiesV3, doesn't need to be encoded

      if (j === StorageNames.cookieNameV3) {
        b = h.convertSDKv1CookiesV3ToSDKv2CookiesV4(k), c(b, StorageNames.cookieNameV3);
        break;
      }
    }
  }
  ...
  function d(b) {
    try {
      ...
      for (var d in b = JSON.parse(b), b) b.hasOwnProperty(d) && (CookiesGlobalSettingsKeys[d] ? c.gs[d] = b[d] : "mpid" === d ? c.cu = b[d] : b.mpid && (c[b.mpid] = c[b.mpid] || {}, MPIDKeys[d] && (c[b.mpid][d] = b[d])));

      return JSON.stringify(c);
    } catch (b) {
      a.Logger.error("Failed to restructure previous cookie into most current cookie schema");
    }
  }

  function e() {
    var b = StorageNames.localStorageProductsV4,
        c = localStorage.getItem(StorageNames.localStorageProductsV4);
    localStorage.setItem(a._Store.prodStorageName, c), localStorage.removeItem(b);
  }
  ...
  function f(b, c) {
    if (a._Store.isLocalStorageAvailable) {
      ...
      if (d[c] = {}, b.cp) {
        try {
          d[c].cp = JSON.parse(Base64.decode(b.cp));
        } catch (a) {
          d[c].cp = b.cp;
        }

        Array.isArray(d[c].cp) || (d[c].cp = []);
      }

      localStorage.setItem(a._Store.prodStorageName, Base64.encode(JSON.stringify(d)));
    }
  }
  ...
  function g() {
    function b(b, c) {
      try {
        window.localStorage.setItem(encodeURIComponent(a._Store.storageName), b);
      } catch (b) {
        a.Logger.error("Error with setting localStorage item.");
      }

      window.localStorage.removeItem(encodeURIComponent(c));
    }
    ...
    var c,
        ...
        g,
        i,
        j = StorageNames.localStorageNameV3,
        k = StorageNames.localStorageNameV4,
        l = window.localStorage.getItem(a._Store.storageName);

    if (!l) {
      if (d = window.localStorage.getItem(k), d) return b(d, k), void e();

      if (g = window.localStorage.getItem(j), g) {
        ...
        if ((g.cp || g.pb) && !g.mpid) return c = a._Persistence.getCookie(), c ? (f(g, c.cu), void localStorage.removeItem(StorageNames.localStorageNameV3)) : void localStorage.removeItem(StorageNames.localStorageNameV3);
      }
    }
  }

  var h = this; //  if there is a cookie or localStorage:
  ...
  this.migrate = function () {
    try {
      ...
      a._Persistence.expireCookies(StorageNames.cookieNameV3), a._Persistence.expireCookies(StorageNames.cookieNameV4), a.Logger.error("Error migrating cookie: " + b);
    }

    if (a._Store.isLocalStorageAvailable) try {
      g();
    } catch (b) {
      localStorage.removeItem(StorageNames.localStorageNameV3), localStorage.removeItem(StorageNames.localStorageNameV4), a.Logger.error("Error migrating localStorage: " + b);
    }
  }, this.convertSDKv1CookiesV3ToSDKv2CookiesV4 = function (b) {
    b = a._Persistence.replacePipesWithCommas(a._Persistence.replaceApostrophesWithQuotes(b));
    var c = JSON.parse(b),
        e = JSON.parse(d(b));
    return c.mpid && (e.gs.csm.push(c.mpid), e.gs.csm = Base64.encode(JSON.stringify(e.gs.csm)), f(c, c.mpid)), JSON.stringify(e);
  };
}
...
function Forwarders(a, b) {
  ...
  this.initForwarders = function (b, d) {
    ...
    !a._Store.webviewBridgeEnabled && a._Store.configuredForwarders && (a._Store.configuredForwarders.sort(function (a, b) {
      ...
      return f.initialized || (f.init(f.settings, d, !1, null, h, g, a._Store.SDKConfig.appVersion, a._Store.SDKConfig.appName, a._Store.SDKConfig.customFlags, a._Store.clientId), f.initialized = !0), !0;
    }));
    ...
    try {
      if (f && a._Helpers.isObject(f) && Object.keys(f).length) for (var h in f) if (f.hasOwnProperty(h) && (d = a._Helpers.generateHash(h).toString(), e = a._Helpers.generateHash(f[h]).toString(), d === b.userAttributeName && e === b.userAttributeValue)) {
        g = !0;
        break;
      }
    ...
    var c,
      ...
      b.UserIdentities && b.UserIdentities.length && b.UserIdentities.forEach(function (d, e) {
        a._Helpers.inArray(c, d.Type) && (b.UserIdentities.splice(e, 1), 0 < e && e--);
      });
    },
        g = function (b, c) {
      var d;
      if (c) for (var e in b.EventAttributes) b.EventAttributes.hasOwnProperty(e) && (d = a._Helpers.generateHash(b.EventCategory + b.EventName + e), a._Helpers.inArray(c, d) && delete b.EventAttributes[e]);
    },
        h = function (b, c) {
    ...
    if (!a._Store.webviewBridgeEnabled && a._Store.activeForwarders) {
      d = a._Helpers.generateHash(b.EventCategory + b.EventName), e = a._Helpers.generateHash(b.EventCategory);
      ...
      for (var k = 0; k < a._Store.activeForwarders.length; k++) {
        ...
        if (-1 < j.indexOf(b.EventDataType) && a._Store.activeForwarders[k].filteringEventAttributeValue && a._Store.activeForwarders[k].filteringEventAttributeValue.eventAttributeName && a._Store.activeForwarders[k].filteringEventAttributeValue.eventAttributeValue) {
          ...
          if (b.EventAttributes) for (var m in b.EventAttributes) {
            var n;
            if (n = a._Helpers.generateHash(m).toString(), n === a._Store.activeForwarders[k].filteringEventAttributeValue.eventAttributeName && (l = {
              name: n,
              value: a._Helpers.generateHash(b.EventAttributes[m]).toString()
            }), l) break;
          }
  ...
  }, this.callSetUserAttributeOnForwarders = function (c, d) {
    b && b.isAttributeKeyBlocked(c) || a._Store.activeForwarders.length && a._Store.activeForwarders.forEach(function (b) {
      if (b.setUserAttribute && b.userAttributeFilters && !a._Helpers.inArray(b.userAttributeFilters, a._Helpers.generateHash(c))) try {
        var e = b.setUserAttribute(c, d);
        e && a.Logger.verbose(e);
      } catch (b) {
        a.Logger.error(b);
      }
    });
  ...
  }, this.configureForwarder = function (b) {
    var c = null,
        d = b,
        e = {}; // if there are kits inside of mpInstance._Store.SDKConfig.kits, then mParticle is self hosted

    for (var f in a._Helpers.isObject(a._Store.SDKConfig.kits) && 0 < Object.keys(a._Store.SDKConfig.kits).length ? e = a._Store.SDKConfig.kits : 0 < a._preInit.forwarderConstructors.length && a._preInit.forwarderConstructors.forEach(function (a) {
      e[a.name] = a;
    }), e) if (f === d.name && (d.isDebug === a._Store.SDKConfig.isDevelopmentMode || d.isSandbox === a._Store.SDKConfig.isDevelopmentMode)) {
      c = new e[f].constructor(), c.id = d.moduleId, c.isSandbox = d.isDebug || d.isSandbox, c.hasSandbox = "true" === d.hasDebugString, c.isVisible = d.isVisible, c.settings = d.settings, c.eventNameFilters = d.eventNameFilters, c.eventTypeFilters = d.eventTypeFilters, c.attributeFilters = d.attributeFilters, c.screenNameFilters = d.screenNameFilters, c.screenNameFilters = d.screenNameFilters, c.screenAttributeFilters = d.screenAttributeFilters, c.userIdentityFilters = d.userIdentityFilters, c.userAttributeFilters = d.userAttributeFilters, c.filteringEventAttributeValue = d.filteringEventAttributeValue, c.filteringUserAttributeValue = d.filteringUserAttributeValue, c.eventSubscriptionId = d.eventSubscriptionId, c.filteringConsentRuleValues = d.filteringConsentRuleValues, c.excludeAnonymousUser = d.excludeAnonymousUser, a._Store.configuredForwarders.push(c);
      break;
    }
    ...
    if (!b) a.Logger.warning("No config was passed. Cannot process forwarders");else try {
      Array.isArray(b.kitConfigs) && b.kitConfigs.length && b.kitConfigs.forEach(function (a) {
        c.configureForwarder(a);
      }), Array.isArray(b.pixelConfigs) && b.pixelConfigs.length && b.pixelConfigs.forEach(function (a) {
        c.configurePixel(a);
      }), c.initForwarders(a._Store.SDKConfig.identifyRequest.userIdentities, d);
    } catch (b) {
      a.Logger.error("Config was not parsed propertly. Forwarders may not be initialized.");
    }
  };
}
...
function ServerModel(a) {
  ...
  function d(b) {
    return {
      id: a._Helpers.parseStringOrNumber(b.Sku),
      nm: a._Helpers.parseStringOrNumber(b.Name),
      pr: a._Helpers.parseNumber(b.Price),
      qt: a._Helpers.parseNumber(b.Quantity),
      br: a._Helpers.parseStringOrNumber(b.Brand),
      va: a._Helpers.parseStringOrNumber(b.Variant),
      ca: a._Helpers.parseStringOrNumber(b.Category),
      ps: a._Helpers.parseNumber(b.Position),
      cc: a._Helpers.parseStringOrNumber(b.CouponCode),
      tpa: a._Helpers.parseNumber(b.TotalAmount),
      attrs: b.Attributes
    };
  }
  ...
  this.appendUserInfo = function (b, c) {
  ...
  }, this.convertToConsentStateDTO = function (a) {
    if (!a) return null;
    var b = {},
  ...
  }, this.createEventObject = function (b, c) {
    var d = {},
        f = {},
        g = b.messageType === Types.MessageType.OptOut ? !a._Store.isEnabled : null;

    if (a._Store.sessionId || b.messageType == Types.MessageType.OptOut || a._Store.webviewBridgeEnabled) {
      f = b.hasOwnProperty("toEventAPIObject") ? b.toEventAPIObject() : {
        EventName: b.name || b.messageType,
        EventCategory: b.eventType,
        EventAttributes: a._Helpers.sanitizeAttributes(b.data, b.name),
        SourceMessageId: b.sourceMessageId || a._Helpers.generateUniqueId(),
        EventDataType: b.messageType,
        CustomFlags: b.customFlags || {},
        UserAttributeChanges: b.userAttributeChanges,
        UserIdentityChanges: b.userIdentityChanges
      }, b.messageType !== Types.MessageType.SessionEnd && (a._Store.dateLastEventSent = new Date()), d = {
      ...
      }, f.EventDataType === MessageType.AppStateTransition && (f.IsFirstRun = a._Store.isFirstRun, f.LaunchReferral = window.location.href || null), f.CurrencyCode = a._Store.currencyCode;
    ...
    return null;
  }, this.convertEventToDTO = function (d) {
    var f = {
      n: d.EventName,
      et: d.EventCategory,
      ua: d.UserAttributes,
      ui: d.UserIdentities,
      ia: d.IntegrationAttributes,
      str: d.Store,
      attrs: d.EventAttributes,
      sdk: d.SDKVersion,
      sid: d.SessionId,
      sl: d.SessionLength,
      ssd: d.SessionStartDate,
      dt: d.EventDataType,
      dbg: d.Debug,
      ct: d.Timestamp,
      lc: d.Location,
      ...
      eec: d.ExpandedEventCount,
      av: d.AppVersion,
      cgid: d.ClientGeneratedId,
      das: d.DeviceId,
      mpid: d.MPID,
      smpids: d.currentSessionMPIDs
    };
    d.DataPlan && d.DataPlan.PlanId && (f.dp_id = d.DataPlan.PlanId, d.DataPlan.PlanVersion && (f.dp_v = d.DataPlan.PlanVersion));
    var g = e.convertToConsentStateDTO(d.ConsentState);
    return g && (f.con = g), d.EventDataType === MessageType.AppStateTransition && (f.fr = d.IsFirstRun, f.iu = !1, f.at = ApplicationTransitionType.AppInit, f.lr = d.LaunchReferral, f.attrs = null), d.CustomFlags && b(d, f), d.EventDataType === MessageType.Commerce ? (f.cu = d.CurrencyCode, d.ShoppingCart && (f.sc = {
      pl: c(d.ShoppingCart.ProductList)
    }), d.ProductAction ? f.pd = {
      an: d.ProductAction.ProductActionType,
      cs: a._Helpers.parseNumber(d.ProductAction.CheckoutStep),
      co: d.ProductAction.CheckoutOptions,
      pl: c(d.ProductAction.ProductList),
      ti: d.ProductAction.TransactionId,
      ta: d.ProductAction.Affiliation,
      tcc: d.ProductAction.CouponCode,
      tr: a._Helpers.parseNumber(d.ProductAction.TotalAmount),
      ts: a._Helpers.parseNumber(d.ProductAction.ShippingAmount),
      tt: a._Helpers.parseNumber(d.ProductAction.TaxAmount)
    } : d.PromotionAction ? f.pm = {
      an: d.PromotionAction.PromotionActionType,
      pl: d.PromotionAction.PromotionList.map(function (a) {
        return {
          id: a.Id,
          nm: a.Name,
          cr: a.Creative,
    ...
    } : d.ProductImpressions && (f.pi = d.ProductImpressions.map(function (a) {
      return {
        pil: a.ProductImpressionList,
        pl: c(a.ProductList)
      };
    }))) : d.EventDataType === MessageType.Profile && (f.pet = d.ProfileMessageType), f;
  };
}
...
function Identity(t) {
  ...
  */
  ...
  this.checkIdentitySwap = function (e, s, r) {
    ...
    createIdentityRequest: function createIdentityRequest(e, s, r, i, n, o, a) {
      var d = {
        client_sdk: {
          platform: s,
          sdk_vendor: r,
    ...
    */
    identify: function identify(e, r) {
      ...
      if (n && (i = n.getMPID()), o.valid) {
        var a = t._Identity.IdentityRequest.createIdentityRequest(e, Constants.platform, Constants.sdkVendor, Constants.sdkVersion, t._Store.deviceId, t._Store.context, i);
    ...
    */
    logout: function logout(e, r) {
      ...
      if (n && (i = n.getMPID()), o.valid) {
        var a,
            d = t._Identity.IdentityRequest.createIdentityRequest(e, Constants.platform, Constants.sdkVendor, Constants.sdkVersion, t._Store.deviceId, t._Store.context, i);

        t._Helpers.canLog() ? t._Store.webviewBridgeEnabled ? (t._NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.Logout, JSON.stringify(t._Identity.IdentityRequest.convertToNative(e))), t._Helpers.invokeCallback(r, HTTPCodes$2.nativeIdentityRequest, "Logout request sent to native sdk")) : (t._IdentityAPIClient.sendIdentityRequest(d, "logout", r, e, s.parseIdentityResponse, i), a = t._ServerModel.createEventObject({
          messageType: Types.MessageType.Profile
        }), a.ProfileMessageType = Types.ProfileMessageType.Logout, t._Store.activeForwarders.length && t._Store.activeForwarders.forEach(function (e) {
          e.logOut && e.logOut(a);
    ...
    */
    modify: function modify(e, r) {
      ...
      n && (i = n.getMPID());
      var a = e && e.userIdentities ? e.userIdentities : {};

      if (o.valid) {
        var d = t._Identity.IdentityRequest.createModifyIdentityRequest(n ? n.getUserIdentities().userIdentities : {}, a, Constants.platform, Constants.sdkVendor, Constants.sdkVersion, t._Store.context);
    ...
    */
    createAliasRequest: function createAliasRequest(e, s) {
      try {
        ...
        var i = new Date().getTime() - 1e3 * (60 * (60 * (24 * t._Store.SDKConfig.aliasMaxWindow))),
            n = e.getLastSeenTime() || new Date().getTime();
      ...
      setUserAttribute: function setUserAttribute(s, i) {
        ...
        if (t._SessionManager.resetSessionTimer(), t._Helpers.canLog()) {
          ...
          if (t._Store.webviewBridgeEnabled) t._NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.SetUserAttribute, JSON.stringify({
            ...
            g ? (d = !1, a = o[g], delete o[g]) : d = !0, o[s] = i, n && n[e] && (n[e].ua = o, t._Persistence.savePersistence(n, e)), r.sendUserAttributeChangeEvent(s, i, a, d, !1, this), t._Forwarders.initForwarders(r.IdentityAPI.getCurrentUser().getUserIdentities(), t._APIClient.prepareForwardingStats), t._Forwarders.callSetUserAttributeOnForwarders(s, i);
          }
        }
      },
      ...
      */
      removeUserAttribute: function removeUserAttribute(s) {
        ...
        if (t._Store.webviewBridgeEnabled) t._NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.RemoveUserAttribute, JSON.stringify({
          ...
          o && (s = o);
          var a = n[s] ? n[s].toString() : null;
          delete n[s], i && i[e] && (i[e].ua = n, t._Persistence.savePersistence(i, e)), r.sendUserAttributeChangeEvent(s, null, a, !1, !0, this), t._Forwarders.initForwarders(r.IdentityAPI.getCurrentUser().getUserIdentities(), t._APIClient.prepareForwardingStats), t._Forwarders.applyToForwarders("removeUserAttribute", s);
        }
      },
      ...
      */
      setUserAttributeList: function setUserAttributeList(s, n) {
        ...
        if (t._Store.webviewBridgeEnabled) t._NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.SetUserAttributeList, JSON.stringify({
          ...
          o = t._Persistence.getPersistence(), a = this.getAllUserAttributes();

          var p = t._Helpers.findKeyInObject(a, s);

          if (p ? (g = !1, d = a[p], delete a[p]) : g = !0, a[s] = u, o && o[e] && (o[e].ua = a, t._Persistence.savePersistence(o, e)), t._APIClient.shouldEnableBatching()) {
            ...
            if (!d || !Array.isArray(d)) l = !0;else if (n.length !== d.length) l = !0;else for (var c = 0; c < n.length; c++) if (d[c] !== n[c]) {
              l = !0;
              break;
            }
            l && r.sendUserAttributeChangeEvent(s, n, d, g, !1, this);
          }

          t._Forwarders.initForwarders(r.IdentityAPI.getCurrentUser().getUserIdentities(), t._APIClient.prepareForwardingStats), t._Forwarders.callSetUserAttributeOnForwarders(s, u);
        }
      },
      ...
      remove: function remove(s, r) {
        ...
        if (t._Store.webviewBridgeEnabled) t._NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.RemoveFromCart, JSON.stringify(s));else {
          t._SessionManager.resetSessionTimer(), n = t._Persistence.getUserProductsFromLS(e), n && (n.forEach(function (e, t) {
            e.Sku === s.Sku && (o = t, a = e);
          }), -1 < o && (n.splice(o, 1), !0 === r && t._Events.logProductActionEvent(Types.ProductActionType.RemoveFromCart, a)));
  ...
  }, this.parseIdentityResponse = function (r, i, n, o, a) {
    var d,
        g,
        l,
        u,
    ...
    try {
      if (t.Logger.verbose("Parsing \"" + a + "\" identity response from server"), r.responseText && (l = JSON.parse(r.responseText), l.hasOwnProperty("is_logged_in") && (t._Store.isLoggedIn = l.is_logged_in)), (!p || p.getMPID() && l.mpid && l.mpid !== p.getMPID()) && (t._Store.mpid = l.mpid, p && t._Persistence.setLastSeenTime(i), !t._Persistence.getFirstSeenTime(l.mpid) && (g = !0), t._Persistence.setFirstSeenTime(l.mpid)), 200 === r.status) {
        if ("modify" === a) c = t._Identity.IdentityRequest.combineUserIdentities(y, o.userIdentities), t._Persistence.saveUserIdentitiesToPersistence(i, c);else {
          var _ = s.IdentityAPI.getUser(l.mpid),
              v = _ ? _.getUserIdentities().userIdentities : {},
              m = t._Helpers.extend({}, v); //if there is any previous migration data


          if (t.Logger.verbose("Successfully parsed Identity Response"), "identify" == a && p && l.mpid === p.getMPID() && t._Persistence.setFirstSeenTime(l.mpid), u = t._Store.currentSessionMPIDs.indexOf(l.mpid), t._Store.sessionId && l.mpid && i !== l.mpid && 0 > u && t._Store.currentSessionMPIDs.push(l.mpid), -1 < u && (t._Store.currentSessionMPIDs = t._Store.currentSessionMPIDs.slice(0, u).concat(t._Store.currentSessionMPIDs.slice(u + 1, t._Store.currentSessionMPIDs.length)), t._Store.currentSessionMPIDs.push(l.mpid)), t._CookieSyncManager.attemptCookieSync(i, l.mpid, g), s.checkIdentitySwap(i, l.mpid, t._Store.currentSessionMPIDs), Object.keys(t._Store.migrationData).length) {
            c = t._Store.migrationData.userIdentities || {};
            var S = t._Store.migrationData.userAttributes || {};

            t._Persistence.saveUserAttributesToPersistence(l.mpid, S);
          } else o && o.userIdentities && Object.keys(o.userIdentities).length && (c = s.IdentityRequest.combineUserIdentities(v, o.userIdentities));

          t._Persistence.saveUserIdentitiesToPersistence(l.mpid, c), t._Persistence.update(), t._Persistence.findPrevCookiesBasedOnUI(o), t._Store.context = l.context || t._Store.context;
        }
        if (d = t.Identity.getCurrentUser(), o && o.onUserAlias && t._Helpers.Validators.isFunction(o.onUserAlias)) try {
          t.Logger.warning("Deprecated function onUserAlias will be removed in future releases"), o.onUserAlias(p, d);
        } catch (s) {
          t.Logger.error("There was an error with your onUserAlias function - " + s);
        }

        var P = t._Persistence.getPersistence();

        d && (t._Persistence.storeDataInMemory(P, d.getMPID()), (!p || d.getMPID() !== p.getMPID() || p.isLoggedIn() !== d.isLoggedIn()) && t._Forwarders.initForwarders(d.getUserIdentities().userIdentities, t._APIClient.prepareForwardingStats), t._Forwarders.setForwarderUserIdentities(d.getUserIdentities().userIdentities), t._Forwarders.setForwarderOnIdentityComplete(d, a), t._Forwarders.setForwarderOnUserIdentified(d, a));
        var b = {};

        for (var A in c) b[Types.IdentityType.getIdentityName(t._Helpers.parseNumber(A))] = c[A];

        s.sendUserIdentityChangeEvent(b, a, l.mpid, "modify" === a ? I : m);
      }

      n ? 0 === r.status ? t._Helpers.invokeCallback(n, HTTPCodes$2.noHttpCoverage, l || null, d) : t._Helpers.invokeCallback(n, r.status, l || null, d) : l && l.errors && l.errors.length && t.Logger.error("Received HTTP response code of " + r.status + " - " + l.errors[0].message), t._APIClient.processQueuedEvents();
    } catch (s) {
    ...
    var o, a;
    if (t._APIClient.shouldEnableBatching() && (i || "modify" === r)) for (var d in o = this.IdentityAPI.getUser(i), e) if (n[d] !== e[d]) {
      var g = !n[d];
      a = s.createUserIdentityChange(d, e[d], n[d], g, o), t._APIClient.sendEventToServer(a);
    }
  ...
  }, this.sendUserAttributeChangeEvent = function (e, r, i, n, o, a) {
    if (t._APIClient.shouldEnableBatching()) {
      var d = s.createUserAttributeChange(e, r, i, n, o, a);
      d && t._APIClient.sendEventToServer(d);
    }
  }, this.createUserAttributeChange = function (e, s, r, i, n, o) {
    r || (r = null);
    var a;
    return s !== r && (a = t._ServerModel.createEventObject({
...
function Consent(a) {
  var b = this,
      c = "data_sale_opt_out"; // this function is called when consent is required to determine if a cookie sync should happen, or a forwarder should be initialized

  this.isEnabledForUserConsent = function (b, c) {
    if (!b || !b.values || !b.values.length) return !0;
    if (!c) return !1;
    var d,
        e = {},
        f = c.getConsentState();
    ...
    if (f) {
      ...
      if (g) for (var h in g) g.hasOwnProperty(h) && (d = a._Helpers.generateHash("1" + h).toString(), e[d] = g[h].Consented);
      var i = f.getCCPAConsentState();
      i && (d = a._Helpers.generateHash("2" + "data_sale_opt_out").toString(), e[d] = i.Consented);
    }

    var j = b.values.some(function (a) {
      var b = a.consentPurpose,
          c = a.hasConsented;
      if (e.hasOwnProperty(b)) return e[b] === c;
    });
    return b.includeOnMatch === j;
    ...
    toMinifiedJsonObject: function toMinifiedJsonObject(a) {
      ...
      if (a) {
        ...
        if (d) for (var e in b.gdpr = {}, d) if (d.hasOwnProperty(e)) {
          var f = d[e];
          b.gdpr[e] = {}, "boolean" == typeof f.Consented && (b.gdpr[e].c = f.Consented), "number" == typeof f.Timestamp && (b.gdpr[e].ts = f.Timestamp), "string" == typeof f.ConsentDocument && (b.gdpr[e].d = f.ConsentDocument), "string" == typeof f.Location && (b.gdpr[e].l = f.Location), "string" == typeof f.HardwareId && (b.gdpr[e].h = f.HardwareId);
        }
        var g = a.getCCPAConsentState();
        g && (b.ccpa = {}, b.ccpa[c] = {}, "boolean" == typeof g.Consented && (b.ccpa[c].c = g.Consented), "number" == typeof g.Timestamp && (b.ccpa[c].ts = g.Timestamp), "string" == typeof g.ConsentDocument && (b.ccpa[c].d = g.ConsentDocument), "string" == typeof g.Location && (b.ccpa[c].l = g.Location), "string" == typeof g.HardwareId && (b.ccpa[c].h = g.HardwareId));
      }

      return b;
    },
    fromMinifiedJsonObject: function fromMinifiedJsonObject(a) {
      var d = b.createConsentState();
      if (a.gdpr) for (var e in a.gdpr) if (a.gdpr.hasOwnProperty(e)) {
        var f = b.createPrivacyConsent(a.gdpr[e].c, a.gdpr[e].ts, a.gdpr[e].d, a.gdpr[e].l, a.gdpr[e].h);
        d.addGDPRConsentState(e, f);
      }

      if (a.ccpa && a.ccpa.hasOwnProperty(c)) {
        var g = b.createPrivacyConsent(a.ccpa[c].c, a.ccpa[c].ts, a.ccpa[c].d, a.ccpa[c].l, a.ccpa[c].h);
        d.setCCPAConsentState(g);
      }

      return d;
    }
  }, this.createConsentState = function (d) {
    function e(a) {
    ...
    */
    ...
    function f(c, d) {
      ...
      if (!a._Helpers.isObject(d)) return a.Logger.error("Invoked with a bad or empty consent object."), this;
      var g = b.createPrivacyConsent(d.Consented, d.Timestamp, d.ConsentDocument, d.Location, d.HardwareId);
      return g && (l[f] = g), this;
    }

    function g(b) {
      if (!b) l = {};else if (a._Helpers.isObject(b)) for (var c in l = {}, b) b.hasOwnProperty(c) && f(c, b[c]);
      return this;
    }
    /**
    ...
    */
    ...
    function j(d) {
      if (!a._Helpers.isObject(d)) return a.Logger.error("Invoked with a bad or empty CCPA consent object."), this;
      var e = b.createPrivacyConsent(d.Consented, d.Timestamp, d.ConsentDocument, d.Location, d.HardwareId);
      return e && (m[c] = e), this;
    }
    /**
    ...
    */
    ...
    function k() {
      return delete m[c], this;
    }

    var l = {},
        m = {};
    return d && (g(d.getGDPRConsentState()), j(d.getCCPAConsentState())), {
      setGDPRConsentState: g,
      addGDPRConsentState: f,
      setCCPAConsentState: j,
      getCCPAConsentState: function a() {
        return m[c];
      },
      getGDPRConsentState: i,
      removeGDPRConsentState: h,
      removeCCPAState: function b() {
        return a.Logger.warning("removeCCPAState is deprecated and will be removed in a future release; use removeCCPAConsentState instead"), k();
      },
      removeCCPAConsentState: k
    };
  };
}
/*
  ...
  */
  ...
  this._instanceName = a, this._NativeSdkHelpers = new NativeSdkHelpers(this), this._Migrations = new Migrations(this), this._SessionManager = new SessionManager(this), this._Persistence = new _Persistence(this), this._Helpers = new Helpers(this), this._Events = new Events(this), this._CookieSyncManager = new cookieSyncManager(this), this._ServerModel = new ServerModel(this), this._Ecommerce = new Ecommerce(this), this._ForwardingStatsUploader = new forwardingStatsUploader(this), this._Consent = new Consent(this), this._IdentityAPIClient = new IdentityAPIClient(this), this._preInit = {
    ...
    */
    ...
    b._preInit.integrationDelays[a] = c;
  };
...
function completeSDKInitialization(a, b, c) {
  ...
  if (c._APIClient = new APIClient(c, d), c._Forwarders = new Forwarders(c, d), b.flags) {
    if (b.flags.hasOwnProperty(Constants.FeatureFlags.EventsV3)) {
      // TODO: Remove this after 8/12/2022
      if ("100" !== b.flags[Constants.FeatureFlags.EventsV3]) {
        c.Logger.warning("mParticle will be enabling Event Batching for all customers on July 12, 2022. For more details, please see our docs: https://docs.mparticle.com/developers/sdk/web/getting-started/");
      }

      c._Store.SDKConfig.flags[Constants.FeatureFlags.EventsV3] = b.flags[Constants.FeatureFlags.EventsV3];
    }

    b.flags.hasOwnProperty(Constants.FeatureFlags.EventBatchingIntervalMillis) && (c._Store.SDKConfig.flags[Constants.FeatureFlags.EventBatchingIntervalMillis] = b.flags[Constants.FeatureFlags.EventBatchingIntervalMillis]);
  }
...
function runPreConfigFetchInitialization(a, b, c) {
  a.Logger = new Logger(c), a._Store = new Store(c, a), window.mParticle.Store = a._Store, a._Store.devToken = b || null, a.Logger.verbose(Messages.InformationMessages.StartingInitialization); //check to see if localStorage is available for migrating purposes
...
function () {
  ...
  return a.prototype.getMPInstance = function () {
    ...
    var b = this.getMPInstance(),
        c = new ServerModel(b).createEventObject(a),
        d = convertEvents("0", [c], b);
    return d;
  }, a;
}();
...
var mediaSession = new _webMediaSdk.default(_webSdk.default, // mParticle SDK Instance
'1234567', // Custom media ID
'Funny Internet cat video', // Custom media Title
120000, // Duration in milliseconds
'Video', // Content Type (Video or Audio)
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            t = "https://" + host + "/userprofile/v1/1115/4614/8425/" + e + "?fields=user_identities,user_attributes,audience_memberships,attribution";
            e = {
              headers: new Headers({
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (mutation.type == "attributes" && mutation.target.className.indexOf("NavigationTab-module--active") > -1) {
          (function () {
            console.log("Target: " + mutation.target.tagName + " --- " + mutation.target.className + " --- " + mutation.type);
            var s_Category = mutation.target.innerText;
            var o_subcategory_base = document.evaluate('//*[contains(@class, "' + nav_base_dropdown_class + '")]', mutation.target.parentElement.parentElement.parentElement, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);

            if (o_subcategory_base.snapshotLength > 0) {
              (function () {
                var o_links = o_subcategory_base.snapshotItem(0).getElementsByTagName("a");
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        o_personalise_base = document.evaluate('//*[contains(@class, "' + personalise_class + '")]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
  ...
  if (o_category_base.snapshotLength > 0) {
    ...
    var _loop2 = function _loop2(i) {
      if (o_categories[i].innerText.indexOf("LOOKBOOK") > -1 || o_categories[i].innerText.indexOf("THE TREATMENT FILES") > -1) {
        o_categories[i].addEventListener('click', function (evt) {
          _webSdk.default.logEvent('View_Category', _webSdk.default.EventType.Navigation, {
    ...
    for (var i = 0; i < o_categories.length; i++) {
      _loop2(i);
    }
  }
...
},{"@mparticle/web-sdk":"../../node_modules/@mparticle/web-sdk/dist/mparticle.esm.js","@mparticle/web-media-sdk":"../../node_modules/@mparticle/web-media-sdk/dist/mparticle-media.common.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
