...
},{}],"www.tennistv.com.demo.js":[function(require,module,exports) {
"use strict";
...
var WEBKEY = localStorage.mpKey || "us2-0fa58b8b0225074ba03bab2a9297acad"; // Configure mParticle as needed for your project
...
_webSdk.default.init('us2-0fa58b8b0225074ba03bab2a9297acad', mParticleConfig);
      ...
      if (!b_section[i_section]) {
        ...
        switch (true) {
          case regex_gallery.test(section_class):
            ...
            var a_topNews_base = document.evaluate('.//*[contains(@class, "' + topNews_class + '")]', curr_section, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null); //console.log(i_section + " : " + b_section[i_section] + " -- " + a_topNews_base.snapshotLength)
              ...
              (function (i_item, s_section) {
                try {
                  ...
                  if (a_links.length > 0) {
                    ...
                    var s_newsTitle = "News Title";
                    var s_newsPublisher = "OneFootball";
                    var s_newsDatetime = new Date().toISOString().split("T")[0] + "T00:00:00+00:00";
                    ...
                    o_link.addEventListener('click', function (evt) {
                      _webSdk.default.logEvent('View_Detail', _webSdk.default.EventType.Navigation, {
                        "Section": s_section,
            ...
            for (var i_item = 0; i_item < a_upcoming_base.snapshotLength; i_item++) {
              (function (i_item, s_section) {
                try {
                  ...
                  curr_item.addEventListener('click', function (evt) {
                    _webSdk.default.logEvent('View_Detail', _webSdk.default.EventType.Navigation, {
                      "Section": s_section,
                      "Match_Teams": s_teams,
      ...
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (mutation.type == "childList" && mutation.target.tagName.indexOf("OF-XPA-LAYOUT-HOME") > -1 || mutation.type == "characterData") {
          ...
          if (mutation.type == "characterData") {
            b_section = Array(i_section_len).fill(false);
          }
                    ...
                    for (var i_item = 0; i_item < a_upcoming_base.snapshotLength; i_item++) {
                      (function (i_item, s_section) {
                        try {
                          var curr_item = a_upcoming_base.snapshotItem(i_item);
                          var a_teams = curr_item.getElementsByClassName(teamname_class);
                          var s_teams = a_teams[0].innerText.trim() + " : " + a_teams[1].innerText.trim(); //var s_gameDatetime = curr_item.getElementsByTagName("time").length > 0?curr_item.getElementsByTagName("time")[0].dateTime.replace("Z", "+00:00"):curr_item.getElementsByClassName("simple-match-card__info-message")[0].innerText.trim();
...
function mp_init() {
  ...
  document.body.appendChild(tmp.children[0]); //Add hyper link click events

  hyperlink_events(); //Track video play activities
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (mutation.type == "attributes" && mutation.target.tagName.indexOf("VIDEO") > -1 && mutation.target.className.indexOf("jw-video") > -1) {
          var a_videos = document.evaluate('.//*[@aria-label = "Video Player" and contains(@class, "jwplayer") and name() = "div"]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null); //console.log("General Mutation: "+ mutation.target.tagName + " --- " + mutation.target.className + " --- " + mutation.type + "\n" + a_videos.snapshotItem(0).id);
          ...
          if (a_videos.snapshotLength > 0) {
            if (!b_jwplayer) {
              ...
              (function () {
                o_player = jwplayer(a_videos.snapshotItem(0).id);
                o_id_match = window.location.href.match(/^.+?-(\d+)$/);
                ...
                o_media_title = document.getElementsByClassName("title__container");
                ...
                o_media_provider = document.getElementsByClassName("news-provider__title");
  ...
  var observer_video = new MutationObserver(callback);

  if (targetNode) {
    observer_video.observe(targetNode, config);
  }

  var callback_match = function callback_match(mutationsList, observer) {
        ...
        if (mutation.type == "childList" && mutation.target.tagName == "DIV" && mutation.target.className == "ott-hero-gallery__teams") {
          if (!b_purchase_event) {
            ...
            if (o_purchase_btn_base.snapshotLength > 0) {
              ...
              try {
                var s_livegame_provider;
                var s_livegame_teams;
                var s_livegame_competition;
                var s_livegame_datetime;

                (function () {
                  s_livegame_provider = "OneFootball";
                  s_livegame_teams = "OneFootball";
                  s_livegame_competition = "OneFootball";
                  s_livegame_datetime = "OneFootball";
                  ...
                  var s_name = s_livegame_competition + " --- " + s_livegame_teams;
                  var s_brand = s_livegame_provider;
                  var s_category = s_livegame_competition;
                  var s_sku = window.location.href.split("/")[5];
                  var f_price = 3.79;
                  var f_taxrate = 0.20;
                  var i_quantity = 1;
                  var s_coupon = null;
                  ...
                  o_purchase_btn.addEventListener('click', function (evt) {
  ...
  var observer_match = new MutationObserver(callback_match);
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","www.tennistv.com.demo.js"], null)
//# sourceMappingURL=/www.tennistv.com.demo.js.map