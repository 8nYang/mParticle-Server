...
},{}],"www.interaction-design.org.demo.js":[function(require,module,exports) {
"use strict";
...
var WEBKEY = localStorage.mpKey || "us2-347606d5f640dd47bb2296fca9773232"; // Configure mParticle as needed for your project
...
_webSdk.default.init(WEBKEY, mParticleConfig);
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            t = "https://" + host + "/userprofile/v1/5000011/167/262/" + e + "?fields=user_identities,user_attributes,audience_memberships,attribution";
            e = {
              headers: new Headers({
...
function mp_init() {
  ...
  var _loop4 = function _loop4(_i) {
    o_courses_base.snapshotItem(_i).addEventListener('click', function (evt) {
      _webSdk.default.logEvent('View_Detail', _webSdk.default.EventType.Navigation, {
        "Category": o_courses_base.snapshotItem(_i).parentElement.parentElement.childNodes[1].id,
        "Sub_Category": o_courses_base.snapshotItem(_i).parentElement.parentElement.childNodes[1].innerText,
        "Title": o_courses_base.snapshotItem(_i).childNodes[1].getAttribute("title"),
        "Id": o_courses_base.snapshotItem(_i).childNodes[1].getAttribute("data-course-id"),
        "Link": evt.target.href
      });
    });
  };

  for (var _i = 0; _i < o_courses_base.snapshotLength; _i++) {
    _loop4(_i);
  }
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","www.interaction-design.org.demo.js"], null)
//# sourceMappingURL=/www.interaction-design.org.demo.js.map