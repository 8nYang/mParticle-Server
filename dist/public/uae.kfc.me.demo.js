...
},{}],"uae.kfc.me.demo.js":[function(require,module,exports) {
"use strict";
...
function mp_init() {
  ...
  for (var i = 0; i < o_category_base.length; i++) {
    if (o_category_base[i]) {
      o_category_base[i].addEventListener('click', function (evt) {
        curr_sub_category = evt.target.innerText;
        b_switch = false;
        b_add2cart_switch = false;
...
function view_detail(item_id) {
  var product = _webSdk.default.eCommerce.createProduct(document.cr_acts[item_id].args.itm.Description, // Name
...
function purchase(item_id) {
  ...
  var product = _webSdk.default.eCommerce.createProduct(item_name, // Name
  item_id, // SKU
  ...
  var product_delivery = _webSdk.default.eCommerce.createProduct("Delivery", // Name
  "900000-1", // SKU
  9.00, // Price
  1, //Quantity
  null, // Variant
  ...
  _webSdk.default.eCommerce.logProductAction(_webSdk.default.ProductActionType.Purchase, [product, product_delivery], customAttributes, customFlags, transactionAttributes);
...
document.addEventListener('DOMContentLoaded', fire_campaignEvent(), false); //setTimeout(function() {mp_init();hyperlink_events()}, 5000);
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","uae.kfc.me.demo.js"], null)
//# sourceMappingURL=/uae.kfc.me.demo.js.map