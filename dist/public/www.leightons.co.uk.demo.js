...
},{}],"www.leightons.co.uk.demo.js":[function(require,module,exports) {
"use strict";
...
function fire_campaignEvent() {
  ...
  var a_match = curr_location.match(/^https:\/\/www\.leightons\.co\.uk\/\?subject="(.+)"&campaign="(.+)"&medium="(.+)"&publisher="(.+)"/);
  ...
  var a_utm_match = curr_location.match(/^https:\/\/www\.leightons\.co\.uk\/\?utm_medium=([^&]+)&.+&utm_content=([^&]+)&utm_source=([^&]+)&utm_campaign=([^&]+)&.+/);
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","www.leightons.co.uk.demo.js"], null)
//# sourceMappingURL=/www.leightons.co.uk.demo.js.map