...
},{}],"www.drmartens.com.demo.js":[function(require,module,exports) {
"use strict";
...
_webSdk.default.init('us2-347606d5f640dd47bb2296fca9773232', mParticleConfig);
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            t = "https://" + host + "/userprofile/v1/5000011/167/262/" + e + "?fields=user_identities,user_attributes,audience_memberships";
            e = {
              headers: new Headers({
...
function mP_eCommerce_ViewDetail(curr_item) {
  ...
  var product = _webSdk.default.eCommerce.createProduct(o_name, // Name
...
function add2_event() {
  var targetNode = document.getElementById("product-list");
  var config = {
    childList: true,
    subtree: true,
    characterData: true,
              ...
              (function (i_btn) {
                try {
                  ...
                  if (curr_btn.className != add2wish_btn_class) {
                    curr_btn.addEventListener('click', function (evt) {
  ...
  var btn_add2cart_handler = function btn_add2cart_handler() {
    mP_commerce_purchase_bind(size, "cart");
  };

  var sizeNode = document.getElementById("sizeSelector");

  var sizecallback = function sizecallback(mutationsList, observer) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (mutation.type == 'attributes' && mutation.target.className == "selected") {
          ...
          var o_btn_add2cart = document.getElementById("addToCartButton"); //console.log("Size: " + size + "\n" + o_btn_add2cart);

          o_btn_add2cart.removeEventListener('click', btn_add2cart_handler, {
            once: true,
            capture: false
          });
          o_btn_add2cart.addEventListener('click', btn_add2cart_handler, {
            once: true,
            capture: false
          });
          return;
  ...
  var sizeobserver = new MutationObserver(sizecallback);
      ...
      for (var i_oos = 0; i_oos < o_oos_base.snapshotLength; i_oos++) {
        (function (i_oos) {
          try {
            ...
            curr_oos.addEventListener('click', function (evt) {
...
function mp_init() {
  ...
  var o_xpath_base = document.evaluate('//*[contains(@class, "' + item_class + '")]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null); //o_xpath_base = document.evaluate('//*[@*[contains(name(), "data-v-2b3c993f")] and @class="item"]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);

  for (var i_item = 0; i_item < o_xpath_base.snapshotLength; i_item++) {
    (function (i_item) {
      try {
        var curr_item = o_xpath_base.snapshotItem(i_item); //Add to Cart event with add2cart_btn_class

        var view_product_lnk = curr_item.getElementsByTagName("a")[0]; //console.log('+++ Clicked Btn: ' + i_item, view_product_lnk.title);

        if (view_product_lnk.title) {
          view_product_lnk.addEventListener('click', function (evt) {
  ...
  add2_event(); //Vew product event with anchor_class
    ...
    (function (i_nav_top) {
      try {
        ...
        if (curr_link) {
          ...
          curr_link.addEventListener('click', function (evt) {
                    ...
                    (function (i_link, curr_category) {
                      try {
                        if (curr_anchors[i_link]) {
                          curr_anchors[i_link].addEventListener('click', function (evt) {
                            _webSdk.default.logEvent('View_Category', _webSdk.default.EventType.Navigation, {
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","www.drmartens.com.demo.js"], null)
//# sourceMappingURL=/www.drmartens.com.demo.js.map