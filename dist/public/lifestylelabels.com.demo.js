...
},{}],"lifestylelabels.com.demo.js":[function(require,module,exports) {
"use strict";
...
var host = "lifestylelabels.com";
var nav_class = "nav";
var page_class = "header-right__buttons";
var cta_class = "cta-item";
var background_colour = "#359EB!important";
var button_colour = "#359EB";
var customerid = "98760630";
var email = "demo0630@mailinator.com";
var mobile = "+447890120630";
var curr_category = "Lifestyle Labels";
var user_profile = {};
var b_switch = false;
          ...
          case 0:
            ...
            identityRequest = {
              userIdentities: {
                ...
                email: "".concat(email) //mobile_number: `${mobile}`
...
function hyperlink_events() {
  ...
  if (o_nav_base.snapshotLength > 0) {
    ...
    (function () {
      var a_navs = o_nav_base.snapshotItem(0).getElementsByTagName("a");

      for (i_item = 0; i_item < a_navs.length; i_item++) {
        (function (i_item) {
          a_navs[i_item].addEventListener('click', function (evt) {
            _webSdk.default.logPageView(evt.target.innerText, {
  ...
  if (o_link_base.snapshotLength > 0) {
    ...
    (function () {
      var a_links = o_link_base.snapshotItem(0).getElementsByTagName("a");

      for (i_item = 0; i_item < a_links.length; i_item++) {
        (function (i_item) {
          a_links[i_item].addEventListener('click', function (evt) {
            _webSdk.default.logPageView(evt.target.innerText, {
              "Page": evt.target.innerText,
              "Url": evt.target.href
            }, {
  ...
  if (o_cta_base.snapshotLength > 0 && window.location.pathname == "/book-an-appointment") {
    var _loop = function _loop() {
      var curr_item = o_cta_base.snapshotItem(j_item);
          ...
          while (target) {
            if (target instanceof HTMLAnchorElement) {
              if (window.location.hostname != evt.target.hostname) {
                var curr_deviceid = _webSdk.default.getDeviceId();

                var curr_mpid = _webSdk.default.Identity.getCurrentUser().getMPID();

                var curr_cid = _webSdk.default.Identity.getCurrentUser().getUserIdentities().userIdentities.customerid;

                var b_login = _webSdk.default.Identity.getCurrentUser().isLoggedIn();

                var s_crossdomain_params = "devid=" + curr_deviceid + "&login=" + b_login + "&mid=" + curr_mpid + "&cid=" + curr_cid + "&curr_category=" + curr_category;
...
function fire_campaignEvent() {
  ...
  var a_match = curr_location.match(/^https:\/\/lifestylelabels\.com\/\?subject="(.+)"&campaign="(.+)"&medium="(.+)"&publisher="(.+)"/);
  ...
  var a_utm_match = curr_location.match(/^http:\/\/lifestylelabels\.com\/\?utm_campaign=([^&]+)&utm_source=([^&]+)&utm_medium=([^&]+)&utm_content=([^&]+)/);
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lifestylelabels.com.demo.js"], null)
//# sourceMappingURL=/lifestylelabels.com.demo.js.map