...
},{}],"leightons.mysight.uk.demo.js":[function(require,module,exports) {
"use strict";
...
var WEBKEY = localStorage.mpKey || "us2-5844b462fde9e846af3c4ed52516e61a"; //var WEBKEY = "us2-27e27269f26d824a9955e3af6195b24b";
...
if (b_login == "false") {
  _webSdk.default.Store.mpid = curr_mpid;
}
...
var loginDisplay = function loginDisplay(btn) {
  var loggedInAs = _webSdk.default.Identity.getCurrentUser() ? _webSdk.default.Identity.getCurrentUser().getUserIdentities().userIdentities.customerid : null; //console.log(loggedInAs + " ::: " + btn.innerText);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return _webSdk.default.Identity.logout({}, callback);
...
function hyperlink_events() {
  ...
  if (o_link_base.snapshotLength > 0 && !b_store_class) {
    var _loop = function _loop() {
      var curr_item = o_link_base.snapshotItem(i_item);
      var curr_btn = curr_item.getElementsByClassName(store_button_class);

      if (curr_btn.length > 0) {
        var curr_store = curr_item.getElementsByTagName("h5")[0].innerText;

        (function (curr_store) {
          curr_btn[0].addEventListener('click', function (evt) {
            sessionStorage.setItem("Booking - Store", curr_store);

            _webSdk.default.logEvent('Book_Appointment', _webSdk.default.EventType.Other, {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (mutation.type == 'attributes' && mutation.target.className == appointment_type_class) {
          ...
          var o_apptmnt_type_base = document.evaluate('.//*[contains(@class, "' + appointment_type_class + '")]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);

          if (o_apptmnt_type_base.snapshotLength > 0) {
            var curr_selection = o_apptmnt_type_base.snapshotItem(0);
            curr_type = curr_selection.firstChild.firstChild.innerText;
            sessionStorage.setItem("Booking - Type", curr_type);
          }

          if (!b_booking_type) {
            document.getElementsByClassName(appointment_type_button_class)[0].addEventListener('click', function (evt) {
              _webSdk.default.logEvent('Book_Appointment', _webSdk.default.EventType.Other, {
        ...
        if (mutation.type == 'attributes' && mutation.target.className == appointment_type_button_class && mutation.target.innerText == "BOOK NOW" && !mutation.target.disabled) {
          try {
            var s_dd = document.getElementsByClassName(dd_selection_class)[0].innerText; //let s_mm = Month_Num[document.getElementsByClassName(mm_yy_selection_class)[0].innerText.split(" ")[0].toUpperCase()];

            var s_mm = document.getElementsByClassName(mm_yy_selection_class)[0].innerText.split(" ")[0].substring(0, 3);
            var s_yy = document.getElementsByClassName(mm_yy_selection_class)[0].innerText.split(" ")[1];
            var s_hh_mm_ss = convert2_24h_time(document.getElementsByClassName(time_selection_class)[0].innerText) + ":00";
            var s_date_time = s_dd + " " + s_mm + " " + s_yy + " " + s_hh_mm_ss;
            s_booking_time = new Date(s_date_time).toISOString().replace(/\.\d{3}Z/, "+00:00");
            sessionStorage.setItem("Booking - Time", s_booking_time);
            var o_staff_base = document.evaluate('.//*[@class="' + staff_class + '" and @data-test-id = "choose_date_time_appointment_is_with_text"]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
          ...
          if (!b_booking) {
            mutation.target.addEventListener('click', function (evt) {
              _webSdk.default.logEvent('Book_Appointment', _webSdk.default.EventType.Other, {
...
function personalise_banner() {
  ...
  if ("user_attributes" in user_profile && "recommended_Product" in user_profile.user_attributes && user_profile.user_attributes["recommended_Product"]) {
    ...
    if (o_personalise_base.snapshotLength > 0) {
      var _s_personalisation = user_profile.user_attributes["recommended_Product"];
      var _s_email = user_profile.user_identities[1].value;
      var o_personalise_base = document.evaluate('//*[contains(@class, "' + personalise_class + '") and @data-gtm-action = "dossier homepage - 3 - small"]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);

      if (o_personalise_base.snapshotLength > 0) {
        o_personalise_base.snapshotItem(0).getElementsByTagName("img")[0].src = "https://demo.mp.com/img/" + _s_personalisation.replaceAll(" ", "_").toLowerCase() + "_7935552.jpeg";

        _webSdk.default.logEvent('Deliver_Personalisation', _webSdk.default.EventType.Other, {
          "Personalisation_Type": "Web_GTM",
          "Personalisation_Content": _s_personalisation,
          "Customer_Email": _s_email
        });
      }
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","leightons.mysight.uk.demo.js"], null)
//# sourceMappingURL=/leightons.mysight.uk.demo.js.map